export const info ={
    ...
    miniBio:[
        ...
        { emoji: "📧", 
        text: "Jhasmani_97_97@hotmail.com"
        }
    ],
    socials: [ 
...
skills:
{
    proficientWith: ['javascript', 'react', 'git', 'github', 'bootstrap', 'html5', 'css3', 'figma', 'storybook', 'sass'], exposedTo: ['nodejs', 'laravel']
