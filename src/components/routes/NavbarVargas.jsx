...
import './NavbarVargas.css'
export const NavbarVargas =({darkMode, handlerClick}) =>{
    const location= useLocation ();
    const [active,setActive]=useState(location.pathname==='/'?'home':location.pathname.slice(1,location.pathname.length));
    console.log("~ file:NavbarVargas.jsx ~ line 29 ~ NavbarVargas ~ active",active)
    return (
        ...
        <Grid item xs={8} component ={'section'}className={''}>
            ...
            <Grid item xs={2} component={'section'}>
                ...
                {
                    darkMode ?
                    <img className='bombilla' onClick={handlerClick}
